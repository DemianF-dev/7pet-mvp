...
// Use the same connection string from .env with proper SSL settings
const connectionString = 'postgresql://postgres.zpcwgsjsktqjncnpgaon:s%23Dfs%407185%2A@aws-0-us-west-2.pooler.supabase.com:5432/postgres?sslmode=verify-full';
