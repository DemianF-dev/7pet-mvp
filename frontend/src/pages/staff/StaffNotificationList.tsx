                    ...
                    <div className="space-y-4">
                        {notifications.length === 0 ? (
                            ...
                            notifications.map(notification => (
                                ...
                                >
                                    <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${notification.type === 'SYSTEM' ? 'bg-amber-100 text-amber-500' : 'bg-primary/10 text-primary'}`}>
                                        <Bell size={20} />
                                    </div>
