...
const statusColumns = [
    { key: 'PENDENTE', label: 'Solicitados', color: 'bg-orange-400' },
    { key: 'CONFIRMADO', label: 'Confirmados', color: 'bg-blue-500' },
    { key: 'EM_ATENDIMENTO', label: 'Em Atendimento', color: 'bg-orange-600' },
            ...
            <main className="flex-1 md:ml-64 p-4 md:p-8">
                <header className="mb-6 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-4xl font-extrabold text-secondary">Agenda <span className="text-orange-600 underline decoration-wavy decoration-2 underline-offset-8">LOG</span></h1>
