                ...
                <div className="p-6 border-b border-gray-50 flex items-center justify-between bg-white">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative group">
                            ...
                            >
                                <option value="MONTH">Mês (Agenda SPA)</option>
                                ...
                                <React.Fragment key={idx}>
                                    ...
                                    <div
                                        className={`min-h-[140px] p-1.5 border-r border-b border-gray-100/60 group transition-all relative
                                            ...
                                            ${isToday ? 'bg-blue-50/30 ring-1 ring-inset ring-blue-100/50' : ''}
                                        `}
                                    >
                                        <div className="flex justify-end p-1 mb-1">
                                            <span className={`text-[11px] font-black flex items-center justify-center
                                                ...
                                                ${isToday ? 'bg-primary text-white w-5 h-5 rounded-md shadow-sm' : ''}
                                            `}>
                                                {day.getDate()}
                                            </span>
                                        </div>
                                        ...
                                        <div className="space-y-[2px]">
                                            {dayAppts.slice(0, 8).map(appt => {
                                                ...
                                                const dotColor = appt.status === 'PENDENTE' ? 'bg-purple-500' :
                                                    appt.status === 'CONFIRMADO' ? 'bg-blue-500' :
                                                        appt.status === 'EM_ATENDIMENTO' ? 'bg-purple-600' : 'bg-green-500';
                                            ...
                                            {dayAppts.length > 8 && (
                                                <button
                                                    ...
                                                    className="w-full mt-1 py-1 text-[8px] font-black text-primary/60 hover:text-primary uppercase flex items-center justify-center gap-1 hover:bg-primary/5 rounded-md transition-all"
                                                >
