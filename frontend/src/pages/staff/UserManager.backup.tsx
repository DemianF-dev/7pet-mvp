        ...
        ...(isMaster ? [{
            ...
            render: (u: UserData) => (
                <div className="flex items-center gap-3">
                    <button
                        onClick={(e) => { e.stopPropagation(); togglePasswordVisibility(u.id); }}
        ...
        },
        {
            ...
            render: (u) => (
                <div className="flex items-center justify-end gap-2">
                    {u.customer?.id && (
                        <button
                            onClick={(e) => { e.stopPropagation(); handleOpenCustomerDetail(u.customer!.id); }}
                            className="p-2.5 bg-blue-50 text-blue-500 hover:bg-blue-100 rounded-xl transition-all"
                        >
                            <User size={18} />
                        </button>
                    )}
                    <button onClick={() => handleDeleteUser(u)} className="p-2.5 hover:bg-red-50 text-red-500 hover:bg-red-100 rounded-xl transition-all">
                        <Trash2 size={18} />
                    </button>
                </div>
            )
