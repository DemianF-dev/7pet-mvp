                ...
                <div className="flex flex-wrap gap-4 mb-6">
                    {(['ROUND_TRIP', 'PICK_UP', 'DROP_OFF'] as const).map((type) => (
                        <button
                            ...
                            className={`flex-1 py-3 px-4 rounded-xl font-bold text-sm transition-all border-2 ${transportType === type ? 'bg-purple-600 text-white border-purple-600 shadow-lg' : 'bg-white text-gray-500 border-transparent hover:bg-purple-50 hover:text-purple-600'}`}
                        >
                                    ...
                                    <tr>
                                        <td colSpan={3} className="px-6 py-4 text-right">
                                            <div className="flex flex-col items-end">
                                                ...
                                                <span className="text-sm font-bold text-gray-400">R$ {calculation.total.toFixed(2)}</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex flex-col items-end">
