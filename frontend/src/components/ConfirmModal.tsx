                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="p-8 text-center">
                            ...
                            <h3 className="text-2xl font-black text-secondary mb-3 leading-tight">{title}</h3>
                            <p className="text-gray-500 font-medium text-sm leading-relaxed mb-8">{description}</p>
